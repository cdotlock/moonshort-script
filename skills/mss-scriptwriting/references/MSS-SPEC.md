...
- Achievement 是 inline step，step 本身携带完整元数据：`{"type":"achievement","id":"...","name":"...","rarity":"...","description":"..."}`。signal step 形如 `{"type":"signal","kind":"mark","event":"..."}`
