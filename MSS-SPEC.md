...
- Achievement 是 inline step，step 本身携带完整元数据：`{"type":"achievement","achievement_id":"...","name":"...","rarity":"...","description":"..."}`。语义 id 用 `achievement_id` 字段（与所有 step 通用的 cursor `id` 字段区分，参见 §4.0 Step ID）。
