...
| T20 | 状态指令组：@affection / @butterfly / @signal mark | `@affection ±N` / `@butterfly` / `@signal mark` |
...
| # | 测试点 | 指令/特性 |
|---|---|---|
| T30 | position 5 档一字排开 | `left_far` / `left` / `center` / `right` / `right_far` |
...
| `comparison` | T23/T26 ep01 / T32/T33 ep02 / T29c gate / T54d,e stress |
