...
// 目标: position 3 档全覆盖、char_look transition=dissolve、rarity rare/epic/legendary、==/!=/>/<

@episode main:02 "Parade Finale" {

  // ================================================================
  // SCENE 1 — position 3 档全部出场（left / center / right）
  // ================================================================

  @bg set cafeteria
  &music play lunch
  &malia show flat at left
  &mark show grin at center
  &mauricio show smirk at right

  NARRATOR: [T30] position 3 档: left / center / right 同屏出场。
