@episode main:03 "Bad Idea #3" {
  ...
  @malia expr sitting_frozen
  @mauricio expr standing_jaw_tight

  @sfx play glass_breaking

  @mauricio expr standing_controlled
