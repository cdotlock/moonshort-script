@episode main:04 "Bad Idea #4" {
  ...
  @signal EP04_COMPLETE

  @gates {
    @gate main/route/easton:01 {
      type: choice
      trigger: A any
    }
    @gate main/route/mauricio:01 {
      type: choice
      trigger: B any
    }
    @gate main/route/mark:01 {
      type: choice
      trigger: C any
    }
    @gate main/route/elias:01 {
      type: choice
      trigger: D any
    }
    @default main:05
