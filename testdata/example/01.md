@episode main:01 "Bad Idea" {
  ...
  @choice {
    @option A safe "Let him come." {
      ...
      @signal mark EASTON_LET_APPROACH
      &affection easton +1
  ...
  @malia look neutral_looking_out
