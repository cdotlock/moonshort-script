@episode main:02 "Bad Idea #2" {
  ...
  @choice {
    @option A safe "That means something to me." {
      ...
      @signal mark EASTON_ACKNOWLEDGED
      &affection easton +2
  ...
  @choice {
    ...
    @option B safe "I'll take the bus." {
      ...
      @mauricio look neutral_almost_smiling
      ...
      @signal mark MAURICIO_REFUSED_RIDE
