@episode main:04 "Bad Idea #4" {
  ...
  &josie show neutral_entering at left_far
  ...
  @easton show neutral_looking at right_far

  EASTON: Mal? You out here?

  @elias look sitting_phone

  @signal mark ELIAS_CRACK
  &affection elias +2
  ...
  @choice {
    ...
    @option B safe "Reply to Mauricio." {
      @signal mark ROUTE_LEAN_MAURICIO
